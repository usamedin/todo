...
import { getTodosMockHandler } from './getTodosMock';
...
export default function addEndpoints(app: Express) {
  ...
  app.get('/mock/external-todo/todos', (request: Request, response: Response) => handlerMiddleware(getTodosMockHandler, request, response))
}
